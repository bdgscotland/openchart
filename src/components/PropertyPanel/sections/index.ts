/**
 * Property Panel Sections - Phase 2 Core Components
 *
 * These sections represent the core property groups that replace the
 * cluttered accordion interface from the old system.
 */
